...
<head>
    ...
    <meta name="description" content="Sistema de Moderación VaeBridge - Transparencia y Juego Limpio">
    <meta name="author" content="VaeBridge">
    <link href="<?php echo $this->page->resource('../logo.png'); ?>" rel="shortcut icon">
    <!-- CSS -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="litebans-navbar">
                ...
                <ul class="nav navbar-nav my-2 my-lg-0">
                    <a href="../index.html" style="font-family: 'Orbitron', sans-serif; color: #00d9ff; font-weight: 700;">
                       ← Volver a VaeBridge
                    </a>
                </ul>
            </div>
