...
class es_ES {
    public function __construct() {
        ...
        $array["index.welcome.main"] = "Sistema de Moderación de {server}";
        $array["index.welcome.sub"] = "Transparencia total - Consulta el historial completo de sanciones del servidor";
